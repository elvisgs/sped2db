Sequel.migration do
  change do
    create_table :reg_e310 do
      ...
      column :vl_sld_cred_ant_fcp, BigDecimal, size: [18, 2]
      column :vl_tot_deb_fcp, BigDecimal, size: [18, 2]
      column :vl_out_deb_fcp, BigDecimal, size: [18, 2]
      column :vl_tot_cred_fcp, BigDecimal, size: [18, 2]
      column :vl_out_cred_fcp, BigDecimal, size: [18, 2]
      column :vl_sld_dev_ant_fcp, BigDecimal, size: [18, 2]
      column :vl_deducoes_fcp, BigDecimal, size: [18, 2]
      column :vl_recol_fcp, BigDecimal, size: [18, 2]
      column :vl_sld_cred_transportar_fcp, BigDecimal, size: [18, 2]
      column :deb_esp_fcp, BigDecimal, size: [18, 2]
